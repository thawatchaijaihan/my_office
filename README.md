...
│       ├── handleText.ts         # คำสั่งแอดมิน (help, sync, review, summary, AI chat)
...
- คอลัมน์สำคัญ:
  - **M** = สถานะชำระเงิน: `ชำระเงินแล้ว` / `ค้างชำระเงิน` / `ลบข้อมูล` (ว่าง = รอกำหนด)
...
| `summary` / `สรุป` / `สรุปวันนี้` | สรุปจำนวนรายการ M/N และ Top 5 ค้างชำระ |

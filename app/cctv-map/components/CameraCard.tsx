        ...
        >
          {showImage ? (
            ...
            <svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true">
              <path
                fill="currentColor"
                d="M3.3 2.3 2 3.6l3.2 3.2C3.2 8.2 2 10 2 12c0 0 3 7 10 7 2.1 0 3.9-.6 5.4-1.5l3.1 3.1 1.3-1.3L3.3 2.3zm8.7 14.7c-3.3 0-5.7-2.3-6.9-4 0-.1.8-1.3 2.4-2.4l2 2a4 4 0 0 0 5.3 5.3l1.6 1.c-1 .3-2 .5-3.4.5zm9-5c0 0-1.2 2.7-4 4.4l-2.1-2.1a4 4 0 0 0-5.3-5.3L7.7 6c1.3-.7 2.8-1 4.3-1 7 0 10 7 10 7z"
              />
            </svg>
          )}
        </button>
